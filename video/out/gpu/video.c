...
const struct m_sub_options gl_video_conf = {
    .opts = (const m_option_t[]) {
        ...
        {"target-peak", OPT_CHOICE(target_peak, {"auto", 0}),
            M_RANGE(10, 10000)},
        {"target-min-luma", OPT_FLOAT(target_min_luma), M_RANGE(0, 1)},
        {"target-max-cll", OPT_FLOAT(target_max_cll), M_RANGE(0, 10000)},
        {"target-max-fall", OPT_FLOAT(target_max_fall), M_RANGE(0, 10000)},
